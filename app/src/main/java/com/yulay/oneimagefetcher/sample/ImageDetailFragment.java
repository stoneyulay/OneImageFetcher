...
import com.yulay.imagefetcher.ImageWorker;
...
public class ImageDetailFragment extends Fragment implements ImageWorker.OnImageLoadedListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (ImageDetailActivity.class.isInstance(getActivity())) {
            OneImageFetcher.with(getActivity()).load(mImageUrl)
                    .fadeIn(false)
                    .into(mImageView);
            /*OneImageFetcher.with(getActivity()).loadImage(mImageUrl, mImageView, null, this);*/
        }
